 ...
 */
@Entity
@Table(name = "estado_requisicion")
public class EstadoRequisicion extends BaseEntity implements Serializable {
    ...
    @Id
    @Column(name = "id_estado_requisicion", nullable = false, insertable = true, updatable = true)
    public Long getId() {
        return id;
    }
